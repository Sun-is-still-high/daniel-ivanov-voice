...
$SITE_CONFIG = [
    ...
    'author' => [
        'name' => 'Даниил Иванов',
        'bio' => 'Психолог, который работает с айтишниками и не только. Сам работал в IT: 6 лет программировал на TypeScript в продуктовых и аутсорс-компаниях. Веду подкаст «Психопогромизм», где говорю о психологии на языке программистов — без «прими себя», с конкретными инструментами. Подробнее обо мне и моём психологическом образовании — на личном сайте.',
