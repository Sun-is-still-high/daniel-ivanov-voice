    ...
    <article class="max-w-6xl mx-auto">
        <section class="hero-panel rounded-[8px] px-8 py-10 md:px-14 md:py-16 mb-14">
            <div class="relative z-10 max-w-5xl">
                ...
                <h1 class="display-title text-4xl md:text-6xl mb-6 max-w-4xl">
                    Сайт о психологии, который не отнимает у человека внимание
                </h1>
                <p class="text-xl md:text-2xl text-[color:var(--ink-2)] leading-relaxed max-w-4xl mb-10">
            ...
            <div class="relative z-10 grid gap-5 md:grid-cols-3">
                <div class="glass-panel rounded-[8px] p-6 md:p-7">
                    <p class="soft-kicker mb-4">Принцип проекта</p>
                    <p class="text-[color:var(--ink-2)] leading-relaxed">
        ...
        <section class="grid lg:grid-cols-[1.15fr_0.85fr] gap-8 mb-14">
            <div class="section-shell rounded-[8px] p-8 md:p-10">
                <p class="soft-kicker mb-4">Зачем он появился</p>
                <div class="space-y-5 text-lg text-[color:var(--ink-2)] leading-relaxed">
            ...
            <div class="quote-panel rounded-[8px] p-8 md:p-10 self-start">
                <p class="relative z-10 text-xl text-[color:var(--ink-2)] leading-relaxed">
        ...
        <section class="grid md:grid-cols-2 gap-6 mb-14">
            <div class="theme-card">
                ...
                <ul class="space-y-3 text-[color:var(--ink-2)] leading-relaxed">
        ...
        <section class="section-shell rounded-[8px] p-8 md:p-10 mb-14">
            <div class="flex items-end justify-between gap-6 mb-8 flex-wrap">
                <div>
                    <p class="soft-kicker mb-3">Три линии проекта</p>
                    <h2 class="display-title text-3xl md:text-4xl">Один сайт, три режима разговора</h2>
                </div>
            ...
            <div class="theme-grid">
                <a href="/inside-the-silence/" class="theme-card">
                    <p class="soft-kicker mb-3">Тихий режим</p>
                    <h3 class="text-2xl font-bold text-[color:var(--ink)] mb-3">Внутри тишины</h3>
                    <p class="text-[color:var(--ink-2)] leading-relaxed">Практики и медитации для перегруженной головы и возвращения в настоящее.</p>
                </a>
                <a href="/netlenka/" class="theme-card">
                    <p class="soft-kicker mb-3">Честный режим</p>
                    <h3 class="text-2xl font-bold text-[color:var(--ink)] mb-3">Нетленка</h3>
                    <p class="text-[color:var(--ink-2)] leading-relaxed">Блог вслух. Короткие, плотные тексты о психологии, терапии и жизни без красивых ширм.</p>
                </a>
                <a href="/rebel-psychology/" class="theme-card">
                    <p class="soft-kicker mb-3">Интеллектуальный режим</p>
                    <h3 class="text-2xl font-bold text-[color:var(--ink)] mb-3">Психопогромизм</h3>
                    <p class="text-[color:var(--ink-2)] leading-relaxed">Подкаст для технарей и системно мыслящих людей, которым нужен разговор на равных.</p>
                </a>
            </div>
        </section>
            ...
            <div class="grid md:grid-cols-[0.55fr_1fr] gap-8 items-start">
                <div>
                    <img
                        ...
                        class="portrait-mono w-full max-w-xs rounded-[8px] object-cover"
                ...
                <div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <a href="<?= e($SITE_CONFIG['social']['telegram']) ?>" target="_blank" rel="noopener noreferrer" class="theme-card">Telegram</a>
                        <a href="<?= e($SITE_CONFIG['social']['telegramChannel']) ?>" target="_blank" rel="noopener noreferrer" class="theme-card">Telegram-канал</a>
                        <a href="<?= e($SITE_CONFIG['social']['youtube']) ?>" target="_blank" rel="noopener noreferrer" class="theme-card">YouTube</a>
                        <a href="<?= e($SITE_CONFIG['social']['blog']) ?>" target="_blank" rel="noopener noreferrer" class="theme-card">Блог</a>
                    </div>
                </div>
            </div>
        </section>
