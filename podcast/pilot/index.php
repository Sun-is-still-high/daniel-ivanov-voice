    ...
    <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
                ...
                <!-- Audio Player -->
                <div class="px-6 pb-6">
                    <iframe src="https://player.mave.digital?podcast=rebel-psychology&episode=2&color=rgb(95,128,245)&mute=1&date=1&download=1" style="width: 100%" height="235" scrolling="no" frameborder="no"></iframe>
                </div>
